...
use App\Filament\Resources\RecipeTutorialResource\Pages;
use App\Filament\Resources\RecipeTutorialResource\RelationManagers;
...
class RecipeTutorialResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageRecipeTutorials::route('/'),
        ];
    }
}
